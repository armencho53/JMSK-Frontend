          ...
          <div className="px-6 py-4 max-h-[calc(100vh-200px)] overflow-y-auto">
            <form id="contact-form" onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-500">Full name of the contact person</p>
                  {errors.name && (
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">Company this contact belongs to</p>
                  {errors.company_id && (
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-500">Contact's email address</p>
                  {errors.email && (
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-500">Contact's phone number</p>
                </div>
              </form>
            </div>
